  ...
  return (
    <div className="grid grid-cols-4 gap-4 mb-6">
      <div className="bg-blue-500 text-white rounded-lg p-4">
        ...
        <div className="text-sm opacity-90">排隊中</div>
      </div>
      ...
      <div className="bg-red-500 text-white rounded-lg p-4">
        ...
        <div className="text-sm opacity-90">逾時</div>
      </div>
      
      <div className="bg-green-500 text-white rounded-lg p-4">
        <div className="text-2xl font-bold">{activeWorkstations}</div>
        <div className="text-sm opacity-90">活躍工作站</div>
      </div>
    </div>
  );
};
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <h1 className="text-2xl font-bold text-gray-900">廚房工作站</h1>
      ...
      <div className="px-6 pb-6">
        <div className={cn(
          'bg-white rounded-lg shadow-sm border border-gray-200 p-6 min-h-[calc(100vh-280px)]',
          layoutMode === 'grid' && 'grid grid-cols-2 gap-6'
        )}>
          {renderCurrentView()}
        </div>
      </div>

    ...
    (set, get) => ({
      ...
      quickSwitch: async (credentials: QuickSwitchCredentials): Promise<boolean> => {
        try {
          ...
          const response = await fetch(AUTH_ENDPOINTS.QUICK_SWITCH, {
            method: 'POST',
            headers: { 
              'Authorization': `Bearer ${authToken}`,
              'Content-Type': 'application/json'
      ...
      terminateSession: async (deviceId: string): Promise<boolean> => {
        try {
          ...
          const response = await fetch(AUTH_ENDPOINTS.TERMINATE_SESSION, {
            method: 'POST',
            headers: {
              'Authorization': `Bearer ${authToken}`,
              'Content-Type': 'application/json'
      ...
      terminateAllOtherSessions: async (): Promise<boolean> => {
        try {
          ...
          const response = await fetch(AUTH_ENDPOINTS.TERMINATE_ALL_SESSIONS, {
            method: 'POST',
            headers: {
              'Authorization': `Bearer ${authToken}`,
              'Content-Type': 'application/json'
